 ...
 *
 * <p>All fields are optional — only provided fields will be applied during
 * an update operation. Role changes are restricted to administrators at the
 * service layer and should be validated before applying.</p>
 *
 * @since 1.0
 */
@Data
