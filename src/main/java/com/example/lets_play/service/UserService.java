 ...
 *
 * <p>Provides creation, retrieval, updating and deletion of users.
 * It handles password encryption and email-uniqueness checks. The
 * class also participates in method-level role-based authorization
 * decisions.</p>
 *
 * <p>Key features include:</p>
 * <ul>
 *   <li>Secure password hashing with BCrypt</li>
 *   <li>Validation of unique email addresses</li>
 *   <li>Method-level role-based access control</li>
 *   <li>User profile self-management</li>
 * </ul>
 *
 * <p>Integrates with Spring Security for authentication and uses
 * method-level annotations to enforce authorization rules.</p>
 *
...
public class UserService {
    ...
    /**
    * Password encoder for secure password hashing using the BCrypt
    * algorithm.
    *
